...
// SHow section Custom
  ...
  // Function to show the popup and apply the blur
  function showPopup() {
	document.querySelector(".site-wrap").classList.add("blur");
  ...
  function hidePopup() {
	document.querySelector(".site-wrap").classList.remove("blur");
